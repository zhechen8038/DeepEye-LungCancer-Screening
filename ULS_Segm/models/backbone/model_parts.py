...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        # self.dwconv = DWConv(hidden_features,hidden_features,3)
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        :param dropout_attention: (float) Dropout rate of attention map
        :param dropout_path:sequential_self_attention:  (float) Dropout in main path
        :param (bool) If true sequential self-attention is performed
        """
        # Call super constructor
        ...
        self.normalization_1: nn.Module = GlobalResponseNorm(in_channels)
        self.normalization_2: nn.Module = nn.LayerNorm(normalized_shape=in_channels)
    ...
    def forward(self,
        ...
        # output_feed_forward: torch.Tensor = (output_feed_forward + output_feed_forward.mean(dim=1, keepdim=True)) * 0.5
